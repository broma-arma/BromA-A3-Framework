...
_coinBase = _this select 4;
_coinDistance = _this select 5;
_str_coin = str _coin;
_str_coinOp = str _coinOp;
_basepos = getMarkerPos _coinBase;

_COINCond = format ["!(_this distance %1 > %2)", _basepos,_coinDistance];
...
_coin setvariable ["BIS_COIN_areasize",[15,15]];
_coin setvariable ["BIS_COIN_actionCondition",_COINCond];
...
F_keyPressed = compile preprocessfile "engine\f\common\F_keyPressed.sqf";
