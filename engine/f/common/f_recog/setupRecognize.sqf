...
recognize = compile preprocessFileLineNumbers "engine\f\common\f_recog\recognize.sqf";
recognizeHandler = compile preprocessFileLineNumbers "engine\f\common\f_recog\recognizeHandler.sqf";
recognizeOverlayCtrl = compile preprocessFileLineNumbers "engine\f\common\f_recog\recognizeOverlayCtrl.sqf";
generateLabelText = compile preprocessFileLineNumbers "engine\f\common\f_recog\generateLabelText.sqf";
