...
/*
      ...
      For any help with scripts pertaining to the F2 Framework, check out
        the F2 online manual at (http://www.ferstaberinde.com/f2/en/).
...
missionPlayerSide = west;            // Side the players belong to
colorPlayerSide = "blue";            // Color of the player side.
playerFactionName = "NATO";          // Player faction name.

// =============================================================================

missionEnemySide = east;             // Side the enemies belong to
colorEnemySide = "red";              // Color of the enemy side.
enemyFactionName = "CSAT";           // Enemy faction.
...
publicVariable "useCasualtyCap";publicVariable "casualtyGroupPlayer";publicVariable "casualtyGroupEnemy"; publicVariable "casualtyPercentage";
publicVariable "casualtyEnding";publicVariable "useCoinModule";publicVariable "timeLimitEnding";
publicVariable "civCapEnding";publicVariable "useEEcheck";publicVariable "EEGroupName";
publicVariable "EEObjectName";publicVariable "EEdistance";publicVariable "EEending";
publicVariable "allowJIP";publicVariable "useSpawnProtection";publicVariable "spawnSize";
publicVariable "DAC_STRPlayers";publicVariable "DAC_Single_Config";
publicVariable "missionPlayerSide";publicVariable "missionwinEnd";publicVariable "missionfailEnd";
publicvariable "firstSide"; publicvariable "fourthSide"; publicvariable "secondSide"; publicvariable "thirdSide";

settingsLoad = true; publicVariable "settingsLoad";
*/